...
response_time_data$responsetimebinned <- cut(response_time_data$responsetime, breaks = c(0,1,5,10,200), labels = c("Rapid (0-1 years)","1.1-5 years","5.1-10 years","Slow (10.1+)"))
